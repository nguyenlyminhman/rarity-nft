...
const serverUrl = 'https://q5wlvuo8jfmr.usemoralis.com:2053/server'; //Moralis Server Url here
const appId = "h4WCOkgutTVd5b2ScEAL5gSCiGOCWdr4GXZKcjxK"; //Moralis Server App ID here
...
const collectionName = "BoredMonkeyCLub2"; //CollectioonName Here
